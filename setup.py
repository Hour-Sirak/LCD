...
setup(
	name = 'LCD',         # How you named your package folder (MyLib)
	packages = ['LCD'],   # Chose the same as "name"
	...
	download_url = 'https://github.com/Hour-Sirak/LCD/releases/tag/v_01',    # I explain this later on
